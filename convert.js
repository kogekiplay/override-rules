  ...
  var init_rules = __esm({
    "src/rules.ts"() {
      ...
      baseRules = [
        ...
        `DOMAIN,servd-anthropic-website.b-cdn.net,${PROXY_GROUPS.CLAUDE}`,
        `DOMAIN-SUFFIX,anthropic.com,${PROXY_GROUPS.CLAUDE}`,
        `DOMAIN-SUFFIX,claude.ai,${PROXY_GROUPS.CLAUDE}`,
        `DOMAIN-SUFFIX,claude.com,${PROXY_GROUPS.CLAUDE}`,
